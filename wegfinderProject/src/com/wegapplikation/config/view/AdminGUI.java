...
public class AdminGUI extends JFrame {
    ...
    private void initializeUI() {
        ...
        JLabel welcomeLabel = new JLabel("Willkommen im Admin Dashboard", SwingConstants.CENTER); // Welcome text in German
        ...
        signOutButton.addActionListener(e -> {
            ...
            loggedInUser = null;
            // Note: Actual sign-out/login screen transition logic is missing here.
        });
